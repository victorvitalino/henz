...
RSpec.describe "vehicle_consumptions/new", type: :view do
  before(:each) do
    assign(:vehicle_consumption, VehicleConsumption.new(
      :vehicle => nil,
      :km_start => 1.5,
      :km_end => 1.5,
      :gas_liter => 1.5,
  ...
  it "renders new vehicle_consumption form" do
    render

    assert_select "form[action=?][method=?]", vehicle_consumptions_path, "post" do
