...
RSpec.describe PaymentTypesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created payment_type" do
        post :create, {:payment_type => valid_attributes}, valid_session
        expect(response).to redirect_to(PaymentType.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved payment_type as @payment_type" do
        post :create, {:payment_type => invalid_attributes}, valid_session
        expect(assigns(:payment_type)).to be_a_new(PaymentType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested payment_type" do
        payment_type = PaymentType.create! valid_attributes
        put :update, {:id => payment_type.to_param, :payment_type => new_attributes}, valid_session
        payment_type.reload
    ...
    context "with invalid params" do
      it "assigns the payment_type as @payment_type" do
        payment_type = PaymentType.create! valid_attributes
        put :update, {:id => payment_type.to_param, :payment_type => invalid_attributes}, valid_session
        expect(assigns(:payment_type)).to eq(payment_type)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the payment_types list" do
      payment_type = PaymentType.create! valid_attributes
      delete :destroy, {:id => payment_type.to_param}, valid_session
      expect(response).to redirect_to(payment_types_url)
    end
  end
