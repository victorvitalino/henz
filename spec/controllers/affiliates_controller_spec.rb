...
RSpec.describe AffiliatesController, type: :controller do
  ...
  # AffiliatesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #index" do
    it "assigns all affiliates as @affiliates" do
      ...
      expect(assigns(:affiliates)).to eq([affiliate])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested affiliate as @affiliate" do
      affiliate = Affiliate.create! valid_attributes
      get :show, {:id => affiliate.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested affiliate as @affiliate" do
      affiliate = Affiliate.create! valid_attributes
      get :edit, {:id => affiliate.to_param}, valid_session
      expect(assigns(:affiliate)).to eq(affiliate)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Affiliate" do
        expect {
          post :create, {:affiliate => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved affiliate as @affiliate" do
        post :create, {:affiliate => invalid_attributes}, valid_session
        expect(assigns(:affiliate)).to be_a_new(Affiliate)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested affiliate" do
        affiliate = Affiliate.create! valid_attributes
        put :update, {:id => affiliate.to_param, :affiliate => new_attributes}, valid_session
        affiliate.reload
      ...
      it "assigns the requested affiliate as @affiliate" do
        affiliate = Affiliate.create! valid_attributes
        put :update, {:id => affiliate.to_param, :affiliate => valid_attributes}, valid_session
        expect(assigns(:affiliate)).to eq(affiliate)
      end
    ...
    context "with invalid params" do
      it "assigns the affiliate as @affiliate" do
        affiliate = Affiliate.create! valid_attributes
        put :update, {:id => affiliate.to_param, :affiliate => invalid_attributes}, valid_session
        expect(assigns(:affiliate)).to eq(affiliate)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested affiliate" do
      affiliate = Affiliate.create! valid_attributes
      expect {
        delete :destroy, {:id => affiliate.to_param}, valid_session
      }.to change(Affiliate, :count).by(-1)
    end
