...
RSpec.describe WorkTypesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested work_type as @work_type" do
      work_type = WorkType.create! valid_attributes
      get :show, {:id => work_type.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested work_type as @work_type" do
      work_type = WorkType.create! valid_attributes
      get :edit, {:id => work_type.to_param}, valid_session
      expect(assigns(:work_type)).to eq(work_type)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new WorkType" do
        expect {
          post :create, {:work_type => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved work_type as @work_type" do
        post :create, {:work_type => invalid_attributes}, valid_session
        expect(assigns(:work_type)).to be_a_new(WorkType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested work_type" do
        work_type = WorkType.create! valid_attributes
        put :update, {:id => work_type.to_param, :work_type => new_attributes}, valid_session
        work_type.reload
      ...
      it "assigns the requested work_type as @work_type" do
        work_type = WorkType.create! valid_attributes
        put :update, {:id => work_type.to_param, :work_type => valid_attributes}, valid_session
        expect(assigns(:work_type)).to eq(work_type)
      end
    ...
    context "with invalid params" do
      it "assigns the work_type as @work_type" do
        work_type = WorkType.create! valid_attributes
        put :update, {:id => work_type.to_param, :work_type => invalid_attributes}, valid_session
        expect(assigns(:work_type)).to eq(work_type)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested work_type" do
      work_type = WorkType.create! valid_attributes
      expect {
        delete :destroy, {:id => work_type.to_param}, valid_session
      }.to change(WorkType, :count).by(-1)
    end
