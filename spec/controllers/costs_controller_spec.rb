  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created cost as @cost" do
        post :create, {:cost => valid_attributes}, valid_session
        expect(assigns(:cost)).to be_a(Cost)
        expect(assigns(:cost)).to be_persisted
      end

      it "redirects to the created cost" do
        post :create, {:cost => valid_attributes}, valid_session
        expect(response).to redirect_to(Cost.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved cost as @cost" do
        post :create, {:cost => invalid_attributes}, valid_session
        expect(assigns(:cost)).to be_a_new(Cost)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested cost" do
        cost = Cost.create! valid_attributes
        put :update, {:id => cost.to_param, :cost => new_attributes}, valid_session
        cost.reload
    ...
    context "with invalid params" do
      it "assigns the cost as @cost" do
        cost = Cost.create! valid_attributes
        put :update, {:id => cost.to_param, :cost => invalid_attributes}, valid_session
        expect(assigns(:cost)).to eq(cost)
      end
